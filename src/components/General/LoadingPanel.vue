<template>
    <div class="w-full h-48 top-0 bg-gray-50 dark:bg-Prt220 border-2 border-t-0 border-gray-200 dark:border-gray-600 flex flex-col justify-center items-center">                                        
